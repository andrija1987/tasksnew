...
class cprojects_list extends cprojects {
	...
	function SetupKeyValues($key) {
		...
		if (count($arrKeyFlds) >= 1) {
			$this->projectid->setFormValue($arrKeyFlds[0]);
			if (!is_numeric($this->projectid->FormValue))
				return FALSE;
		}
		return TRUE;
	}
	...
	function BasicSearchSQL($arKeywords, $type) {
		$sWhere = "";
		$this->BuildBasicSearchSQL($sWhere, $this->projectname, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->budget, $arKeywords, $type);
		return $sWhere;
	}
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->projectstartdate); // projectstartdate
			$this->UpdateSort($this->projectenddate); // projectenddate
	...
	function ResetCmd() {
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				...
				$this->projectstartdate->setSort("");
				$this->projectenddate->setSort("");
				$this->budget->setSort("");
			}
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->projectid->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event, this);'>";
	...
	function RenderOtherOptions() {
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->CustomActions as $action => $name) {
				...
				$item->Body = "<a class=\"ewAction ewCustomAction\" href=\"\" onclick=\"ew_SubmitSelected(document.fprojectslist, '" . ew_CurrentUrl() . "', null, '" . $action . "');return false;\">" . $name . "</a>";
			}
...
var fprojectslistsrch = new ew_Form("fprojectslistsrch");
</script>
<script type="text/javascript">
...
// Header row
$projects->RowType = EW_ROWTYPE_HEADER;
...
<?php if ($projects->projectid->Visible) { // projectid ?>
	<?php if ($projects->SortUrl($projects->projectid) == "") { ?>
		<th data-name="projectid"><div id="elh_projects_projectid" class="projects_projectid"><div class="ewTableHeaderCaption"><?php echo $projects->projectid->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="projectid"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $projects->SortUrl($projects->projectid) ?>',1);"><div id="elh_projects_projectid" class="projects_projectid">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $projects->projectid->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($projects->projectid->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($projects->projectid->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($projects->projectname->Visible) { // projectname ?>
	<?php if ($projects->SortUrl($projects->projectname) == "") { ?>
		<th data-name="projectname"><div id="elh_projects_projectname" class="projects_projectname"><div class="ewTableHeaderCaption"><?php echo $projects->projectname->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="projectname"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $projects->SortUrl($projects->projectname) ?>',1);"><div id="elh_projects_projectname" class="projects_projectname">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $projects->projectname->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($projects->projectname->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($projects->projectname->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($projects->projectstartdate->Visible) { // projectstartdate ?>
	<?php if ($projects->SortUrl($projects->projectstartdate) == "") { ?>
		<th data-name="projectstartdate"><div id="elh_projects_projectstartdate" class="projects_projectstartdate"><div class="ewTableHeaderCaption"><?php echo $projects->projectstartdate->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="projectstartdate"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $projects->SortUrl($projects->projectstartdate) ?>',1);"><div id="elh_projects_projectstartdate" class="projects_projectstartdate">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $projects->projectstartdate->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($projects->projectstartdate->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($projects->projectstartdate->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($projects->projectenddate->Visible) { // projectenddate ?>
	<?php if ($projects->SortUrl($projects->projectenddate) == "") { ?>
		<th data-name="projectenddate"><div id="elh_projects_projectenddate" class="projects_projectenddate"><div class="ewTableHeaderCaption"><?php echo $projects->projectenddate->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="projectenddate"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $projects->SortUrl($projects->projectenddate) ?>',1);"><div id="elh_projects_projectenddate" class="projects_projectenddate">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $projects->projectenddate->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($projects->projectenddate->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($projects->projectenddate->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($projects->budget->Visible) { // budget ?>
	...
	<?php } else { ?>
		<th data-name="budget"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $projects->SortUrl($projects->budget) ?>',1);"><div id="elh_projects_budget" class="projects_budget">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $projects->budget->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($projects->budget->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($projects->budget->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
?>
	<?php if ($projects->projectid->Visible) { // projectid ?>
		<td data-name="projectid"<?php echo $projects->projectid->CellAttributes() ?>>
...
<a id="<?php echo $projects_list->PageObjName . "_row_" . $projects_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($projects->projectname->Visible) { // projectname ?>
		<td data-name="projectname"<?php echo $projects->projectname->CellAttributes() ?>>
<span<?php echo $projects->projectname->ViewAttributes() ?>>
<?php echo $projects->projectname->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($projects->projectstartdate->Visible) { // projectstartdate ?>
		<td data-name="projectstartdate"<?php echo $projects->projectstartdate->CellAttributes() ?>>
<span<?php echo $projects->projectstartdate->ViewAttributes() ?>>
<?php echo $projects->projectstartdate->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($projects->projectenddate->Visible) { // projectenddate ?>
		<td data-name="projectenddate"<?php echo $projects->projectenddate->CellAttributes() ?>>
