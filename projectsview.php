...
class cprojects_view extends cprojects {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["projectid"] <> "") {
			$this->RecKey["projectid"] = $_GET["projectid"];
			$KeyUrl .= "&amp;projectid=" . urlencode($this->RecKey["projectid"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["projectid"] <> "") {
				...
				$this->RecKey["projectid"] = $this->projectid->QueryStringValue;
			} elseif (@$_POST["projectid"] <> "") {
				$this->projectid->setFormValue($_POST["projectid"]);
				$this->RecKey["projectid"] = $this->projectid->FormValue;
			} else {
...
<?php if ($projects->projectid->Visible) { // projectid ?>
	<tr id="r_projectid">
		<td><span id="elh_projects_projectid"><?php echo $projects->projectid->FldCaption() ?></span></td>
...
<?php echo $projects->projectid->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($projects->projectname->Visible) { // projectname ?>
	<tr id="r_projectname">
		<td><span id="elh_projects_projectname"><?php echo $projects->projectname->FldCaption() ?></span></td>
...
<?php echo $projects->projectname->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($projects->projectstartdate->Visible) { // projectstartdate ?>
	<tr id="r_projectstartdate">
		<td><span id="elh_projects_projectstartdate"><?php echo $projects->projectstartdate->FldCaption() ?></span></td>
...
<?php echo $projects->projectstartdate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($projects->projectenddate->Visible) { // projectenddate ?>
	<tr id="r_projectenddate">
		<td><span id="elh_projects_projectenddate"><?php echo $projects->projectenddate->FldCaption() ?></span></td>
...
<?php echo $projects->projectenddate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
