...
// Page object
var tasks_delete = new ew_Page("tasks_delete");
tasks_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = tasks_delete.PageID; // For backward compatibility

// Form object
var ftasksdelete = new ew_Form("ftasksdelete");
...
if ($tasks_delete->Recordset = $tasks_delete->LoadRecordset())
	$tasks_deleteTotalRecs = $tasks_delete->Recordset->RecordCount(); // Get record count
if ($tasks_deleteTotalRecs <= 0) { // No record found, exit
	if ($tasks_delete->Recordset)
		$tasks_delete->Recordset->Close();
	$tasks_delete->Page_Terminate("taskslist.php"); // Return to list
}
?>
<div class="ewToolbar">
...
<?php if ($tasks->taskid->Visible) { // taskid ?>
		<th><span id="elh_tasks_taskid" class="tasks_taskid"><?php echo $tasks->taskid->FldCaption() ?></span></th>
<?php } ?>
<?php if ($tasks->taskname->Visible) { // taskname ?>
		<th><span id="elh_tasks_taskname" class="tasks_taskname"><?php echo $tasks->taskname->FldCaption() ?></span></th>
<?php } ?>
<?php if ($tasks->comment->Visible) { // comment ?>
		<th><span id="elh_tasks_comment" class="tasks_comment"><?php echo $tasks->comment->FldCaption() ?></span></th>
<?php } ?>
<?php if ($tasks->status->Visible) { // status ?>
		<th><span id="elh_tasks_status" class="tasks_status"><?php echo $tasks->status->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $tasks_delete->RowCnt ?>_tasks_taskid" class="tasks_taskid">
...
<span id="el<?php echo $tasks_delete->RowCnt ?>_tasks_taskname" class="tasks_taskname">
...
<span id="el<?php echo $tasks_delete->RowCnt ?>_tasks_comment" class="tasks_comment">
...
<span id="el<?php echo $tasks_delete->RowCnt ?>_tasks_status" class="tasks_status">
